  ...
  <form>
    ...
    <md-card>
      <md-card-header :data-background-color="dataBackgroundColor">
        <h4 class="title">新销售商品</h4>
        <p class="category">创建新销售单</p>
      </md-card-header>
      ...
      <md-card-content>
        <div class="md-layout">
          ...
          <div class="md-layout-item md-small-size-100 md-size-50">
            <md-field>
              <label>客户</label>
              <md-input v-model="custom" type="text"></md-input>
            </md-field>
          </div>
          <div class="md-layout-item md-small-size-100 md-size-33">
            <md-field>
              <label>状态</label>
              <md-select v-model="finished">
          ...
          <div class="md-layout-item md-size-100 text-right">
            <md-button class="md-raised md-success" v-on:click="newsaleitem($event)">创建商品</md-button>
          </div>
        </div>
      </md-card-content>
    </md-card>
